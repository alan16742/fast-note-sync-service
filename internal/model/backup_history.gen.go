...
type BackupHistory struct {
	...
	TriggerID int64      `gorm:"column:trigger_id;not null;index:idx_backup_history_trigger_id;default:0" json:"triggerId" form:"triggerId"`
	VaultID   int64      `gorm:"column:vault_id;not null;index:idx_backup_history_vault_id;default:0" json:"vaultId" form:"vaultId"`
