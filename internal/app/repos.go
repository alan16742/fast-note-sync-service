...
type Repositories struct {
	...
	AutomationExecutionRepo domain.AutomationExecutionRepository
}
...
func initRepositories(d *dao.Dao) *Repositories {
	return &Repositories{
		...
		AutomationRepo:          dao.NewAutomationRepository(d),
		AutomationExecutionRepo: dao.NewAutomationExecutionRepository(d),
	}
}
